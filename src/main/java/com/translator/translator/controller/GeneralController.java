...
import com.translator.translator.dto.request.TranslationRequest;
...
public class GeneralController {
    ...
    public String getUnauthorizedTranslationInfo() {
        return """
               Single unauthorized: GET http://localhost:8080/usage/unauthorized?srcLan=fr&destLang=en&text=Salut
    ...
    public List<String> authorizedTranslation(@Valid @RequestBody TranslationRequest request) throws JsonProcessingException {
        return authorizedTranslationService.verifyTranslate(
            request.getSrcLan(),
            request.getDestLang(),
            request.getText(),
            request.getUserId()
